...
Although these notions interact operationally within diagnostic procedures,
they occupy strictly distinct logical roles in the Ontology of Continua
(OC Core) and the executable specification ETS.K\_EA.
...
A \emph{STOP} outcome is a formally defined terminal state of the diagnostic
process.
...
STOP is therefore a property of the diagnostic procedure, not of the model
state space itself.
\end{definition}
...
Inadmissible inputs are rejected without semantic interpretation.
\end{proposition}
...
invariants, or structural requirements.
\end{proposition}
...
realizations—whereas STOP denotes a controlled termination of inference
under constraint preservation.
