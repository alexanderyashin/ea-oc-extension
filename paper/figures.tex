...
\begin{itemize}
  ...
  \item interaction between continuity $k_{\mathrm{EA}}$, cycles, and
        termination,
  \item phase classification under varying structural conditions.
\end{itemize}
...
They are not empirical measurements, benchmarks, or validation data.
...
parameters.
They illustrate structural phase boundaries and STOP regions.
...
No figure may be used to bypass STOP conditions, invariants, or phase
precedence rules.
If a visual pattern appears to contradict a formal result, the formal
specification takes precedence.

Figures carry no independent diagnostic authority beyond their
illustrative role.
