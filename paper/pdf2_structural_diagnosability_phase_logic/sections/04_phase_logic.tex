...
Each regime is defined exclusively through existence or non-existence statements
concerning feasibility, continuity, and boundary proximity.
...
(i) feasibility is non-empty, and
(ii) at least one compatible realization admits the observed changes as internal
...
\paragraph{Remarks.}
\begin{itemize}
\item Regimes are defined purely through constraints on existing primitives; no
prescriptive interpretation is implied.
