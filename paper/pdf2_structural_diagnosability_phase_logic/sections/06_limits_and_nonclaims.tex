...
\subsection{Falsifiability by example (counterexample templates)}
\label{subsec:falsifiability-templates-wrapper}

We additionally provide explicit counterexample templates (logical refuters) in
an epistemic sense. They specify what would count as a counterexample \emph{in
principle} under admissible assumptions, without prescribing any operational
search or empirical protocol.
