...
Thresholds therefore bound the \emph{domain of definition} of diagnosis,
not its outcomes.
...
Inequality-based formulation is intentional.
It encodes admissibility relations and precedence logic without
introducing metric assumptions, scales, or optimization criteria.

No numerical values are fixed at the theory level.
Any quantitative instantiation occurs outside the theory and does not
alter the formal structure or admissibility logic.
...
The presence of multiple components does not imply additive scoring or
continuous grading.
Each component acts as a logical constraint on admissibility.
...
The formalism therefore encodes admissibility, not preference.
