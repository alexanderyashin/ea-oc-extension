...
The intent of this section is defensive rather than expansive.
It exists to prevent category errors in interpretation, not to argue
for the validity or superiority of OC as a general ontology.
...
These primitives are not metaphors or analytical conveniences.
They constitute the minimal formal requirements for treating an object
as a continuum within OC.
...
This distinction is ontological rather than operational.
It concerns the conditions under which an object remains defined, not
the quality or desirability of its behavior.
...
Continuity therefore expresses definability of transitions, not smooth
gradation or resilience properties.
...
Thresholds thus delimit existence and diagnosability, not performance.
...
This constraint is structural and non-negotiable within OC.
