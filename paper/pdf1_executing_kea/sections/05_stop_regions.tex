...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\linewidth]{../../results/pdf1/stop_regions_demo/stop_regions.pdf}
  \caption{Executable STOP regions mask over a deterministic 2D projection (ETS predicate; tooling-only instantiation recorded in manifest).}
