...
def maybe_make_figures(results: List[Dict[str, Any]]) -> None:
    ...
    print("Wrote 2 figures into figures/.")
...
def main() -> None:
    ...
    with open("results/sim02_fields_summary.csv", "w", newline="", encoding="utf-8") as fcsv:
        w = csv.writer(fcsv)
    ...
    print("Wrote results/sim02_fields.json and results/sim02_fields_summary.csv")

    maybe_make_figures(results)
